        ...
        <div>
          ...
          >
            ...
            <label htmlFor="name">
              <input
                required
                className="bg-neutral-100 dark:bg-neutral-800 p-2 border-b border-stone-300 dark:border-stone-800 w-full rounded-t focus:rounded-b focus:outline-none focus:ring-1 focus:ring-sky-700 valid:border-sky-700"
                type="name"
            ...
            <label htmlFor="text">
              <textarea
                required
                className="bg-neutral-100 dark:bg-neutral-800 p-2 border-b border-stone-300 dark:border-stone-800 h-36 w-full rounded-t focus:rounded-b resize-none focus:outline-none focus:ring-1 focus:ring-sky-700 valid:border-sky-700"
                rows="15"
                as="textarea"
        ...
        >
          <div className="bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 transition py-2 px-2 rounded-full">
            <svg
              ...
              className="fill-sky-900 dark:fill-sky-200 w-[2rem]"
            >
