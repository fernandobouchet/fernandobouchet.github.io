  ...
  return (
    ...
    >
        ...
        <div>
          ...
          >
            ...
            <label htmlFor="name">
              <input
                required
                className="bg-light-surface dark:bg-dark-surface text-light-fontSurface dark:text-dark-fontSurface border-opacity-20 p-2 w-full rounded focus:outline-none focus:ring-1 focus:ring-light-container dark:focus:ring-dark-container transition"
                type="name"
            ...
            <label htmlFor="text">
              <textarea
                required
                className="bg-light-surface dark:bg-dark-surface text-light-fontSurface dark:text-dark-fontSurface p-2 h-36 w-full rounded resize-none focus:outline-none focus:ring-1 focus:ring-light-container dark:focus:ring-dark-container transition"
                rows="15"
                as="textarea"
      ...
      <div className="flex items-center justify-between gap-12">
        ...
        >
          <div className="bg-light-surface hover:opacity-95 dark:bg-dark-surface transition py-2 px-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1024 1024"
              className="fill-light-container dark:fill-dark-container w-[2rem]"
            >
