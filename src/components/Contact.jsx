    ...
    >
      ...
      <div className="flex items-center justify-between gap-12">
        <a
          ...
          rel="noreferrer"
        >
          <div className="border border-neutral-400 hover:bg-neutral-800 transition py-2 px-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1024 1024"
              className="fill-sky-200 w-[1.8rem]"
            >
        ...
        <a href="https://t.me/fernandobouchet" target="_blank" rel="noreferrer">
          <div className="border border-neutral-400 hover:bg-neutral-800 transition py-2 px-2 rounded-full">
            <svg
              className="stroke-sky-200 w-[1.8rem]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
              strokeLinecap="round"
