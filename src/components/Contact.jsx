...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="max-w-5xl mx-auto min-h-screen flex flex-col gap-14 justify-center items-center p-5 pt-16 animate-fadeIn transition"
    >
      <div className="flex flex-col items-center">
        ...
        <p className="text-sm md:text-base max-w-2xl text-center">
          ...
          <a
            ...
            className="font-normal text-blue-600 dark:text-blue-300 font-medium"
          >
        ...
        <div>
          ...
          >
            ...
            <label htmlFor="name">
              <input
                required
                className="bg-neutral-100 dark:bg-neutral-800 p-2 border-b border-stone-300 dark:border-stone-800 w-full rounded-t focus:rounded-b focus:outline-none focus:ring-1 focus:ring-blue-300 valid:border-blue-300 dark:focus:ring-blue-600 dark:valid:border-blue-600"
                type="name"
            ...
            <label htmlFor="text">
              <textarea
                required
                className="bg-neutral-100 dark:bg-neutral-800 p-2 border-b border-stone-300 dark:border-stone-800 h-36 w-full rounded-t focus:rounded-b resize-none focus:outline-none focus:ring-1 focus:ring-blue-300 valid:border-blue-300 dark:focus:ring-blue-600 dark:valid:border-blue-600"
                rows="15"
                as="textarea"
      ...
      <div className="flex items-center justify-between gap-12">
        ...
        >
          <div className="bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 transition py-2 px-2 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 1024 1024"
              className="fill-blue-600 dark:fill-blue-300 w-[2rem]"
            >
