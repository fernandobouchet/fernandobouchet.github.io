const Contact = () => {
  return (
    ...
    >
      <h2 className="font-semibold text-1xl md:text-3xl">Contact me</h2>
      <div>
        <form
        ...
        >
          ...
          <label htmlFor="email">
            <input
              required
              className="bg-inherit p-2 border rounded w-full autofill:"
              type="email"
          ...
          <label htmlFor="text">
            <textarea
              required
              className="bg-inherit p-2 border rounded h-36 w-full"
              rows="15"
              as="textarea"
      ...
      <div className="flex items-center justify-between w-64">
        ...
        >
          <svg
            className="fill-white w-[2.5rem] hover:scale-110 transition"
