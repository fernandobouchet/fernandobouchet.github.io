export const ProjectsData = [
  ...
  },
  {
    id: 1,
    title: "TOP Series",
    info: "Used the TMDB API data to display the most popular series, and allows the user to save their favs and which they would choose to 'watch later'. Used React, React-router, Chakra-UI, Axios.",
    image:
  ...
  },
  {
    ...
    info: "Simple SPA that displays electronics and allows the user to add them to cart and then 'buy' them. Used React, Bootstrap.",
    image:
  ...
  },
  {
    id: 4,
    title: "Quizzical",
    info: "SPA that show random movies questions using the OPEN TDB API. Used React, Vanilla CSS.",
    image:
  ...
  },
  {
    id: 5,
    title: "Taskify",
    info: "Simple TODO list with CRUD functions. Used React, Tailwindcss.",
    image:
...

  {
    ...
    info: "A classic memory game using the 'PokeApi' to fetch the characters of the famous serie. Used React, Vanilla CSS.",
    image:
