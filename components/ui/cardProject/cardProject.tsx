...
const CardProject = ({ project }: Props) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start w-full gap-1 md:gap-4 p-2 md:even:flex-row-reverse backdrop-blur-xl bg-black/10 dark:bg-white/10 rounded-2xl group/card h-full md:h-72">
      <div className="relative flex flex-col items-center w-full h-56 md:h-full md:w-1/2 ">
        {
          ...
          <img
            ...
            alt={project.title}
            loading="lazy"
            className="object-cover object-center w-full h-56 md:h-full transition duration-500 md:scale-95 md:group-hover/card:scale-100 rounded-2xl"
          />
        }
      </div>
      <div className="p-2 md:w-1/2 h-56 md:h-full flex flex-col">
