export const translations = {
  EN: {
    ...
    about: {
      ...
      p1: "I'm a ",
      span1: "University Technician in Programming",
      p2: " and an intermediate student in the ",
      span2: "Bachelor's degree in Computer Science",
      p3: ".",
      p4: "Passionate about full-stack development, I combine a solid academic foundation with a strong commitment to ",
      span3: "self-taught learning",
      p5: ", continually enhancing my skills through both individual and collaborative projects.",
  ...
  ES: {
    ...
    about: {
      ...
      p1: "Soy ",
      span1: "Técnico Universitario en Programación",
      p2: " y estudiante intermedio de la ",
      span2: "Licenciatura en Informática",
      p3: ".",
      p4: " Apasionado por el desarrollo full-stack, combino una sólida formación académica con un fuerte compromiso con el ",
      span3: "aprendizaje autodidacta",
      p5: ", perfeccionando continuamente mis habilidades a través de proyectos individuales y colaborativos.",
